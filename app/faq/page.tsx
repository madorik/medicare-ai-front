...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "업로드된 모든 의료 문서는 분석 완료 후 즉시 삭제됩니다. 개인의 의료 정보는 절대 저장되지 않으며, 제3자와 공유되지 않습니다. 모든 데이터는 암호화되어 안전하게 처리됩니다."
  },
  {
    id: 5,
    category: "개인정보",
    question: "개인정보는 안전한가요?",
    answer: "네, 매우 안전합니다. 모든 데이터는 SSL 암호화를 통해 전송되며, 서버에서는 일시적으로만 처리됩니다. 개인정보보호법을 철저히 준수하며, 의료정보는 분석 후 즉시 완전 삭제됩니다."
  },
  {
    id: 6,
    category: "결제 및 이용",

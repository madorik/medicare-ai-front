...
const faqData: FAQItem[] = [
  ...
  },
  {
    id: 2,
    category: "서비스 이용",
    question: "어떤 종류의 의료 문서를 해석할 수 있나요?",
    answer: "처방전, 혈액검사 결과지, 소변검사 결과지, 진단서, 의사소견서 등 다양한 의료 문서를 해석할 수 있습니다. JPG, PNG, PDF 형식의 파일을 지원합니다."
  },
  {
    id: 3,
    category: "서비스 이용",
  ...
  },
  {
    ...
    answer: "업로드된 의료 문서 파일은 해석 완료 후 즉시 삭제됩니다. 개인의 의료 정보는 절대 제3자와 공유되지 않습니다. 모든 데이터는 암호화되어 안전하게 처리됩니다."
  },
  {
    id: 5,
    category: "개인정보",
    question: "개인정보 보호는 안전한가요?",
    answer: "네, 매우 안전합니다. 모든 데이터는 SSL 암호화를 통해 전송됩니다. 업로드된 의료 문서 파일은 즉시 삭제되며 개인정보보호법을 철저히 준수합니다."
  },
  {
    id: 6,
    category: "결제 및 이용",
  ...
  },
  {
    id: 10,
    category: "건강 정보",
    question: "AI 해석 결과를 의료진에게 보여줘도 되나요?",
    answer: "네, 가능합니다. 다만 AI 해석 결과는 참고 자료일 뿐이며, 정확한 진단과 치료는 의료진의 판단에 따라 이루어져야 합니다. 의료진과 상담 시 원본 검사 결과와 함께 참고 자료로 활용하시기 바랍니다."
  },
  {
    id: 11,
    category: "건강 정보",
    question: "건강검진결과 발급은 어떻게 받나요?",
    answer: "건강검진결과는 검진을 받으신 의료기관에서 직접 발급받으실 수 있습니다. 일반적으로 검진 후 1-2주 이내에 결과가 나오며, 다음과 같은 방법으로 발급받을 수 있습니다:\n\n1. 방문 발급: 검진받은 의료기관에 직접 방문하여 신분증 지참 후 발급\n2. 온라인 발급: 의료기관 홈페이지나 앱을 통한 온라인 발급 (가능한 경우)\n3. 우편 발급: 사전에 요청 시 우편으로 발급 (일부 기관)\n4. 국가건강검진의 경우: 국민건강보험공단 홈페이지(www.nhis.or.kr)에서 온라인 발급 가능\n\n발급 시에는 본인 확인을 위해 신분증이 필요하며, 대리인이 발급받을 경우 위임장과 대리인 신분증이 추가로 필요합니다."
  }
]

const categories = ["전체", "서비스 이용", "개인정보", "결제 및 이용", "기술적 문제", "건강 정보"]

...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "업로드된 의료 문서 파일은 해석 완료 후 즉시 삭제됩니다. 해석 결과와 상담 기록은 서비스 제공 및 품질 개선을 위해 최대 3일간 안전하게 보관된 뒤 자동 삭제됩니다. 개인의 의료 정보는 절대 제3자와 공유되지 않습니다. 모든 데이터는 암호화되어 안전하게 처리됩니다."
  },
  {
    id: 5,
    category: "개인정보",
    question: "개인정보 보호는 안전한가요?",
    answer: "네, 매우 안전합니다. 모든 데이터는 SSL 암호화를 통해 전송됩니다. 업로드된 의료 문서 파일은 즉시 삭제되며, 해석 결과 및 상담 기록은 최대 3일간 안전하게 보관된 후 자동 삭제됩니다. 개인정보보호법을 철저히 준수합니다."
  },
  {
    id: 6,
    category: "결제 및 이용",
